...
public class DirectRTCClient implements AppRTCClient , TCPChannelClient.TCPChannelEvents{
    ...
    // Disconnects from the room.Runs on the looper thread.
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    //Start TCPChannelClient.TCPChannelEvents
    @Override
    public void onTCPConnected(boolean server) {
        if (server) {
            ...
            SignalingParameters parameters = new SignalingParameters(
                    new ArrayList<>(), // Ice servers are not needed for direct connections.
                    server, // Server side acts as the initiator on direct connections.
                    null, // clientId
                    null, // wssUrl
                    null, // wwsPostUrl
                    null, // offerSdp
    ...
    //End TCPChannelClient.TCPChannelEvents
    ///////////////////////////////////////////////////////////////////////////////////////////
