...
public class AppRTCAudioManager {
    ...
    /** AudioManager state. */
    public enum AudioManagerState { UNINITIALIZED, PREINITIALIZED, RUNNING, }
    ...
    // TODO: always set to AudioDevice.NONE today.
    //  Add support for explicit selection based on choice by userSelectedAudioDevice.
    private AudioDevice userSelectedAudioDevice;

    // Contains speaker phone setting: auto, true or false
    ...
    private class WiredHeadsetReceiver extends BroadcastReceiver {
        private static final int STATE_UNPLUGGED = 0; // 没插上插头
        private static final int STATE_PLUGGED = 1; // 插上插头
    ...
    private AppRTCAudioManager(Context context) {
        ...
        useSpeakerphone = sp.getString(context.getString(R.string.pref_speakerphone_key),
    ...
    public void start(AudioManagerEvents audioManagerEvents) {
        ...
        if (amState == AudioManagerState.RUNNING) {
            Log.e(TAG, "AppRTCAudioManager is already active");
            return;
        }
        Log.d(TAG, "AppRTCAudioManager starts...");
        ...
        Log.d(TAG, "AppRTCAudioManager started");
    }
    ...
    public void stop() {
        ThreadUtils.checkIsOnMainThread();
        if (amState != AudioManagerState.RUNNING) {
            Log.e(TAG, "Trying to stop AppRTCAudioManager in incorrect state: " + amState);
            return;
        }
        amState = AudioManagerState.UNINITIALIZED;
        ...
        Log.d(TAG, "AppRTCAudioManager stopped");
    }
    ...
    private boolean HasWiredHeadset() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            final AudioDeviceInfo[] devices = audioManager.getDevices(
                    AudioManager.GET_DEVICES_OUTPUTS|AudioManager.GET_DEVICES_INPUTS);
