...
import com.zzrblog.appwebrtc.util.AsyncHttpURLConnection;
...
public class WebSocketChannelClient {
    ...
    // Do not remove this member variable. If this is removed, the observer gets garbage collected
    // and this causes test breakages.
    private WebSocketObserver wsObserver;
    private final Object closeEventLock = new Object();
    private boolean closeEvent;
    // WebSocket send queue. Messages are added to the queue when WebSocket client is not registered
    // and are consumed in register() call.
    ...
    private void sendWSSMessage(final String method, final String message) {
        ...
        AsyncHttpURLConnection httpConnection =
                new AsyncHttpURLConnection(method, postUrl, message,
