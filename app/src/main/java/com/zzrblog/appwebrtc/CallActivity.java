                                                    ...
                                                    PeerConnectionClient.PeerConnectionEvents
{
    ...
    private static class ProxyVideoSink implements VideoSink {
        ...
        public void onFrame(VideoFrame frame) {
            if (target == null) {
                Log.w(TAG, "Dropping frame in proxy because target is null.");
                return;
            }
    ...
    @Nullable private AppRTCClient appRtcClient;
    @Nullable private AppRTCClient.SignalingParameters signalingParameters;
    @Nullable private SurfaceViewRenderer pipRenderer;
    @Nullable private SurfaceViewRenderer fullscreenRenderer;
    @Nullable private VideoFileRenderer videoFileRenderer;
    ...
    @Nullable AppRTCAudioManager audioManager;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fullscreenRenderer.setOnClickListener(view -> toggleCallControlFragmentVisibility());
        ...
        //}
        ////////////////////////////////////////////////////////////////////////////////////////////
        //TODO：Important NOTE!!! Create peer connection client.
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Start AppRTCClient.SignalingEvents
    // All callbacks are invoked from signaling looper thread and are routed to UI thread.
    @Override
    ...
    private @Nullable VideoCapturer createVideoCapturer() {
        ...
        if (videoFileAsCamera != null) {
            ...
            Log.i(TAG, "Creating video capture using camera2 API.");
            videoCapturer = createCameraCapturer(new Camera2Enumerator(this));
        } else {
            Log.i(TAG, "Creating video capture using camera1 API.");
    ...
    private void logAndToast(String msg) {
        Log.d(TAG, msg);
        Toast logToast = Toast.makeText(this, msg, Toast.LENGTH_SHORT);
        logToast.show();
    }
